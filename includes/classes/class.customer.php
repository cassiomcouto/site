	...
	class ISC_CUSTOMER
	{
		...
		private function LoginCustomer($ClientRecord, $silent=false)
		{
			...
			if (isset($_SESSION['LOGIN_REDIR']) && $_SESSION['LOGIN_REDIR'] != '') {
				...
				header(sprintf("Location: %s/areadecliente.php", $GLOBALS['ShopPathNormal']));
			}
		...
		public function CreateCustomerAccount($Customer, $Email=true, $checkoutAccount=false)
		{
			...
			*/
			...
			if ($Email == true) {
				...
				$GLOBALS['ISC_LANG']['ThanksForRegisteringEmailLogin'] = sprintf(GetLang('ThanksForRegisteringEmailLogin'), $GLOBALS['ShopPathSSL']."/areadecliente.php", $GLOBALS['ShopPathSSL']."/areadecliente.php", $GLOBALS['ShopPathSSL']."/areadecliente.php");
