<?php
	...
	/**
	*	This class handles everything to do with E-mail Marketer integration into Shopping Cart
	*
	*	@author Mitchell Harper
	*	@date November 1st 2007
	*	@copyright QjRkX1N5bnQ0eF9GdWNrX1gtTW9iaWxlc19Zb3VfQml0Y2hlcw==
	*/
	class ISC_ADMIN_SENDSTUDIO
	{

		/**
		*	Get a list of all mailing lists available for the E-mail Marketer user and return them as <option> tags
		*/
		public function GetAvailableMailingListsAsoptions($Selected="", &$NumLists = 0)
		{
			// Get a list of available mailing lists from E-mail Marketer
			$output = "";
			$list_xml = "<xmlrequest>
		...
		/**
		*	Get a list of all mailing lists available for the E-mail Marketer user
		*/
