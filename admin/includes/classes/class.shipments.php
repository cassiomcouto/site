...
/**
 * Shopping Cart Shipment Management.
 */
class ISC_ADMIN_SHIPMENTS
{
	...
	private function CommitShipment($data)
	{
		...
		$newShipment = array(
			...
			// Shipping Details
			'shipshipfirstname' => $order['ordshipfirstname'],
			'shipshiplastname' => $order['ordshiplastname'],
			'shipshipcompany' => $order['ordshipcompany'],
			'shipshipstreet1' => $order['ordshipstreet1'],
			'shipshipstreet2' => $order['ordshipstreet2'],
			'shipshipsuburb' => $order['ordshipsuburb'],
			'shipshipstate' => $order['ordshipstate'],
			'shipshipzip' => $order['ordshipzip'],
			'shipshipcountry' => $order['ordshipcountry'],
