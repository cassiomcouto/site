 ...
 */
$GLOBALS['ISC_CFG']['ControlPanelTitle'] = $GLOBALS['ISC_CFG']['ProductName']." Administração Loja Evollution V10";
 ...
 */
$GLOBALS['ISC_CFG']['AdminCopyright'] = 'Desenvolvimento: <a target="_blank" href="http://www.netexplorer.com.br">www.netexplorer.com.br</a> Versão 6.0  &copy; 2013-'.date('Y').'     ';
 ...
 */
$GLOBALS['ISC_LANG']['BadLKHInv'] = "Sua chave de licença é inválido. Favor entrar em contato com a netexplorer.com.br (www.netexplorer.com.br) para conseguir uma nova chave";
$GLOBALS['ISC_LANG']['BadLKHExp'] = "Sua chave de licença expirou em %s. Favor entrar em contato com a netexplorer.com.br (www.netexplorer.com.br) para conseguir uma nova chave";
