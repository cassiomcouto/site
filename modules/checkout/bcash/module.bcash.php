<?php
	...
	class CHECKOUT_BCASH extends ISC_CHECKOUT_PROVIDER
	{
		...
		*/
		...
		var	$_id = "checkout_bcash";

		/*
			Checkout class constructor
		*/
		function CHECKOUT_BCASH()
		{
	...
	$this->_variables['helptext'] = array("name" => "Mais configura&ccedil;&otilde;es",
		   ...
		   "default" => "<a href=\"javascript:window.open('%%GLOBAL_ShopPath%%/modules/checkout/bcash/repagar.php?pedido=%%GLOBAL_OrderId%%','popup','width=800,height=800,scrollbars=yes');void(0);\"><img src='%%GLOBAL_ShopPath%%/modules/checkout/bcash/images/final.gif' border='0'></a>
<br>",
		   "rows" => 7,
		   "required" => true
		);
...
$billhtml = "
<div class='FloatLeft'><b>Pagamento Online bcash</b>
</div>
".$ms."
<br />
<a href=\"javascript:window.open('".$GLOBALS['ShopPath']."/modules/checkout/bcash/repagar.php?pedido=".$id."','popup','width=800,height=800,scrollbars=yes');void(0);\">
<img src='".$GLOBALS['ShopPath']."/modules/checkout/bcash/images/final.gif' border='0'></a>
</div><br>

Link Direto:<br>
<a href='".$GLOBALS['ShopPath']."/modules/checkout/bcash/repagar.php?pedido=".$id."' target='_blank'>".$GLOBALS['ShopPath']."/modules/checkout/bcash/repagar.php?pedido=".$id."</a>
