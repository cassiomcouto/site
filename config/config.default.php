<?php
	...
	$GLOBALS['ISC_CFG']["StoreName"] = 'Evollution | VERSÃO 10.0';
	...
	$GLOBALS['ISC_CFG']["template"] = 'SPB001';
	...
	// Shipping Settings
	$GLOBALS['ISC_CFG']["CompanyName"] = 'Loja Evllution';
	$GLOBALS['ISC_CFG']["CompanyAddress"] = 'Rua Sete de Setembro';
	$GLOBALS['ISC_CFG']["CompanyCity"] = 'Cascavel';
	$GLOBALS['ISC_CFG']["CompanyCountry"] = 'Brasil';
	$GLOBALS['ISC_CFG']["CompanyState"] = 'Paraná';
	$GLOBALS['ISC_CFG']["CompanyZip"] = '85802100';
