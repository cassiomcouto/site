<?php
	...
	// Last Updated: 29th Sep 2012 @ 4:41 PM

	$GLOBALS['ISC_CFG']["isSetup"] = false;
	$GLOBALS['ISC_CFG']["Language"] = 'br';
	$GLOBALS['ISC_CFG']["AllowPurchasing"] = 1;
	$GLOBALS['ISC_CFG']["serverStamp"] = 'JRLOJAAMxAjM9AzRHZjeE9UdqNkUFtCWYhDTMFnYoNUQBFUQBFUQBFUQRFURBp0TMJlS';
	...
	$GLOBALS['ISC_CFG']["dbDatabase"] = 'm';
	$GLOBALS['ISC_CFG']["tablePrefix"] = 'isc_';
	$GLOBALS['ISC_CFG']["StoreName"] = 'Loja Evollution| VERSÃO 10.0';
	...
	$GLOBALS['ISC_CFG']["template"] = 'LX06';
	$GLOBALS['ISC_CFG']["SiteColor"] = 'coolblue';
	...
	$GLOBALS['ISC_CFG']["InstallDate"] = 1348718559;
	...
	$GLOBALS['ISC_CFG']["DisplayDateFormat"] = 'd/m/Y';
	$GLOBALS['ISC_CFG']["ExportDateFormat"] = 'd/m/Y';
	$GLOBALS['ISC_CFG']["ExtendedDisplayDateFormat"] = 'd/m/Y @ g:i A';
	$GLOBALS['ISC_CFG']["HomeFeaturedProducts"] = 6;
	$GLOBALS['ISC_CFG']["HomeNewProducts"] = 12;
	...
	// Shipping Settings
	$GLOBALS['ISC_CFG']["CompanyName"] = 'Nome de sua empresa';
	$GLOBALS['ISC_CFG']["CompanyAddress"] = 'Rua Tal,  123';
	$GLOBALS['ISC_CFG']["CompanyCity"] = 'São Paulo';
	$GLOBALS['ISC_CFG']["CompanyCountry"] = 'Brazil';
	$GLOBALS['ISC_CFG']["CompanyState"] = 'São Paulo';
	$GLOBALS['ISC_CFG']["CompanyZip"] = '11355450';

	// Checkout Settings
	$GLOBALS['ISC_CFG']["CheckoutMethods"] = 'checkout_bcash,checkout_deposito,checkout_pagseguro';
  ...
  2 => 'Store Credit',
	...
	$GLOBALS['ISC_CFG']['AddonModules'] = 'addon_catalogopdf,addon_enquetes,addon_simularfrete,addon_parcelas';
	...
	$GLOBALS['ISC_CFG']["EncryptionToken"] = 'cb93dc42f00f9d9168182f3bb4235228';
  ...
  3 => 'paymentMethods',
	...
	$GLOBALS['ISC_CFG']['SearchOptimisation'] = 'both';

	// Abandon Orders
	$GLOBALS['ISC_CFG']['AbandonOrderLifetime'] = '30';

	// Product Image Settings
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_width'] = 140;
	$GLOBALS['ISC_CFG']['ProductImagesStorewideThumbnail_height'] = 140;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_width'] = 330;
	$GLOBALS['ISC_CFG']['ProductImagesProductPageImage_height'] = 330;
	$GLOBALS['ISC_CFG']['ProductImagesGalleryThumbnail_width'] = 50;
	$GLOBALS['ISC_CFG']['ProductImagesGalleryThumbnail_height'] = 50;
